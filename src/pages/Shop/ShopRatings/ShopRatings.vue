      ...
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="score-wrapper">
            ...
            <Star :score="shopInfo.foodScore" :size="36"></Star>
            <div class="score">{{shopInfo.foodScore}}</div>
          </div>
          <div class="score-wrapper">
            <span class="title">送达时间</span>
            <span class="score">{{shopInfo.deliveryTime}}</span>
          </div>
        </div>
      </div>
